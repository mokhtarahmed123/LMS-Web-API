...
{
    public class FavouriteCourseValidator : AbstractValidator<favouriteUserCourseCommand>
    {
        private readonly IStringLocalizer<SharedResources> stringLocalizer;

        public FavouriteCourseValidator(IStringLocalizer<SharedResources> stringLocalizer)
        {
